...
import {
  ...
  createNotesByAuthorsMessage,
} from "./nostr-api/createNostrMessage.js";
...
const testAuthor = npubToHex(
  "npub1klnd450j7j6wf4u5jyclamhtq74dsucj525m97nj2k5j9nw462pq0q6xyr",
); // JonNpub
...
Connection.FollowListObservable.subscribe({
  next: (data) => {
    ...
    Connection.sendMessage(
      createNotesByAuthorsMessage(data, filters.since, filters.until, 10),
    );
  },
